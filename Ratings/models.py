...
class Rating(models.Model):
    ...
    doctor_obj = models.ForeignKey('Doctors.Doctor', on_delete=models.CASCADE)
...
# class CharacterConductRatings(models.Model):
    ...
    accepts_responsibility = models.IntegerField(default=0, validators=[MaxValueValidator(100), MinValueValidator(0)])
...
# class ProfessionalSkill(models.Model):
    ...
    improve_care = models.BooleanField(default=0, validators=[MaxValueValidator(100), MinValueValidator(0)])
...
# class Anonymous_Comment_and_Whistelblow(models.Model):    
    ...
    def __str__(self):
        return " ".join([self.doctor_obj.first_name , self.doctor_obj.last_name,  str(self.rating_id)])

    @property
    def doc_name(self):
        return ", ".join([self.doctor_obj.last_name, self.doctor_obj.first_name])
